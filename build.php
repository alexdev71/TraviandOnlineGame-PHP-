...
<body class="v35 webkit <?=$database->bodyClass($_SERVER['HTTP_USER_AGENT']); ?> ar-AE build  <?php if($dorf1==''){echo 'perspectiveBuildings';}else{ echo 'gidResources perspectiveResources';} ?> <?php echo DIRECTION; ?> season- buildingsV3">
