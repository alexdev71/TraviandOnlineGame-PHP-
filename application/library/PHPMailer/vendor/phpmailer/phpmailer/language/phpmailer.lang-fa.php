...
$PHPMAILER_LANG['connect_host']         = 'خطای SMTP: اتص به سرور SMTP برقرار نشد.';
$PHPMAILER_LANG['data_not_accepted']    = 'خطای SMTP: داده‌ها نا‌درست هستند.';
$PHPMAILER_LANG['empty_message']        = 'بخش متن پیام خی است.';
...
$PHPMAILER_LANG['recipients_failed']    = 'خطای SMTP: ارس به آدرس گیرنده با خطا مواجه شد: ';
$PHPMAILER_LANG['signing']              = 'خطا در امضا: ';
$PHPMAILER_LANG['smtp_connect_failed']  = 'خطا در اتص به SMTP.';
$PHPMAILER_LANG['smtp_error']           = 'خطا در SMTP Server: ';
$PHPMAILER_LANG['variable_set']         = 'امکان ارس یا ارس مجدد متغیر‌ها وجود ندارد: ';
