...
<div class=\"build_details researches\">
  ...
  <div class=\"button-content\">".ratusha8."</div>
        ...
        echo '</div></div></div><div class="clear"></div></div>';
			if($level >= 10){
                $i=2;
		$level = $village->resarray['f'.$id];
                echo "
<div class=\"build_details researches\">
    <div class=\"research\">
        <div class=\"information\">
            <div class=\"title\">
                <a><img class=\"celebration celebrationSmall\" src=\"img/x.gif\" alt=\"".ratusha9."\"></a>
                <a>".ratusha9."</a>
            ...
            <div class=\"inlineIconList resourceWrapper\">
                <div class=\"inlineIcon resource\">
                    <i class=\"r1Big\"></i>
                    <span class=\"value value\">".$cel[$i]['wood']."</span>
                </div>
                <div class=\"inlineIcon resource\">
                    <i class=\"r2Big\"></i>
                    <span class=\"value value\">".$cel[$i]['clay']."</span>
                </div>
                <div class=\"inlineIcon resource\">
                    <i class=\"r3Big\"></i>
                    <span class=\"value value\">".$cel[$i]['iron']."</span>
                </div>
                <div class=\"inlineIcon resource\">
                    <i class=\"r4Big\"></i>
                    <span class=\"value value\">".$cel[$i]['crop']."</span>
                </div>
            </div>
            <br>
