...
if($basearray['type_of']!='' && $basearray['oasistype']==0){
    ?>
    <h1 class="titleInHeader"><?=logint43?> <span class="coordinates coordinatesWrapper"><span class="coordinateX"><?php echo "(".$basearray['x'].""; ?></span><span class="coordinatePipe">|</span><span class="coordinateY"><?php echo "".$basearray['y'].")"; ?></span>
...
<h1><?php if($basearray['fieldtype']!=0){
            ...
            echo $oasisname; ?> <span class="coordinates coordinatesWrapper"><span class="coordinateX"><?php echo "(".$basearray['x'].""; ?></span><span class="coordinatePipe">|</span><span class="coordinateY"><?php echo "".$basearray['y'].")"; ?></span>

        </span><?php
        } if($basearray['occupied'] && $basearray['capital']) { echo "<span class=\"mainVillage\">(".OVERVIEW20.")</span>"; }?><span class="clear">&nbsp;</span></h1>
    <div class="detailImage">
        <div id="options">
...
<table cellpadding="1" cellspacing="1" id="distribution" class="transparent">
        ...
        <tr>
            ...
            <td><a target="_top" href="spieler.php?uid=<?php echo $oasis['owner']; ?>"><?php if($oasis['owner']!=2){echo $database->RemoveXSS($database->getUserField($oasis['owner'],'username',0));}else{ echo "Nature";} ?></a></td>
        </tr>
        <tr>
            <th>Village:</th>
            <td><a target="_top" href="karte.php?d=<?php echo $oasis['conqured'];?>&c=<?php echo $generator->getMapCheck($oasis['conqured']);?>"><?php echo $database->RemoveXSS($database->getVillageField($oasis['conqured'], "name"));?></a></td>
        </tr>
        </tbody>
    </table>
<?php }?>
