...
?>
	...
	<div class="stickyImage">
		<a class="build_logo" onclick="return Travian.Game.iPopup(<?php echo $village->resarray['f'.$_GET['id'].'t']; ?>, 4);" href="#">
			<img class="build_logo big black g<?php echo $village->resarray['f'.$_GET['id'].'t'] == 12 ? 13 : $village->resarray['f'.$_GET['id'].'t']; ?>" alt="<?=$lang['buildings'][$village->resarray['f'.$_GET['id'].'t']]?>" src="img/x.gif">
		</a>
	</div>
