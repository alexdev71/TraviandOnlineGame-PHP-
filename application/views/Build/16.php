...
<div id="raidList">
    ...
    if(!$session->goldclub) {
        ?>
    <div class="build_desc"><p>Gold Club, allows you to hide the forces and smuggle them out of the village when there are attacks on the village</p>
            ...
            <div class="button-content">Gold Club</div></div></button>
