...
<div class="boxes-bc"></div>
    ...
    <div class="boxes-contents cf">		<div class="heroStatusMessage header">
			   ...
			   <div class="featureButton" style="float:right">
												<a href="hero_adventure.php?active"><button type="button" class="gold prosButton buyadventure" title="" coins="100" id="buttonbuyadventure" onclick="javascript:window.location='hero_adventure.php?buy'">
													<div class="button-container addHoverClick">
														...
														<div class="button-content">Find Adventure<img src="img/x.gif" class="goldIcon">
															<span class="goldValue">10  &nbsp;  <img src="img/x.gif" alt="Gold" class="gold"></span>
														</div>
													</div>
												</button></a>
											</div>
