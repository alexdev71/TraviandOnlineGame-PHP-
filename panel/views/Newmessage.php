...
##              -= YOU MAY NO.phpMOVE OR CHANGE THIS NOTICE =-                 ##
...

{
	...
	<h4>Compose New Message to <a href="index.php?p=player&uid=<?php echo $user['id'] ?>"><?php echo $user['username']; ?></a></h4>



	<form method="post" action="../panel/Mods/sendMessage.php" accept-charset="UTF-8" name="msg">
	...
	<div id="content" class="messages">
		...
		<div id="read_content" class="msg_content">
			...
			<div id="heading">
				...
				<div><a href="index.php?p=player&uid=<?php echo $user['id']; ?>"><?php echo $user['username']; ?></a></div>
