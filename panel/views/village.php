...

{
...

	{
		...
		<link href="../gpack/lang/ar-AE/compact.css?f4b7c" rel="stylesheet" type="text/css">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<form action="../application/panel/Mods/editVillageOwner.php" method="POST" accept-charset="UTF-8">
				...
				<tr>
					...
					<form action="../application/panel/Mods/renameVillage.php" method="POST" accept-charset="UTF-8">
		...
		<table class="table">
			...
			<thead>
				...
				<tr>
					...
					<form action="../application/panel/Mods/recalcWH.php" method="POST" accept-charset="UTF-8">
