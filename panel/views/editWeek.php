...

{
	...
	<form action="../application/panel/Mods/editWeek.php" method="POST">
			...
			<table class="table" cellpadding="0" cellspacing="0">
				...
				<thead>
					...
					<tr>
						...
						<th colspan="2">Edit Off, Def, Raid Points This Week For: <a href="index.php?p=player&uid=<?php echo $user['id']; ?>"><?php echo $user['username']; ?></a></th>
