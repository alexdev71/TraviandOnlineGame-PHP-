...
##              -= YOU MAY .phpREMOVE OR CHANGE THIS NOTICE =-                 ##
...

{
	...
	?>
.php
	<form action="../application/panel/Mods/editPlus.php" method="POST">
						...
						<table>
							...
							<thead>
								...
								<tr>
									...
									<th colspan="2">Plus and Resource Bonuses for: <a href="index.php?p=player&uid=<?php echo $user['id']; ?>"><?php echo $user['username']; ?></a></th>
			...
			<table class="table" cellpadding="0" cellspacing="0">
				...
				<thead>
					...
					<tr>
						...
						<th col.php="2">Edit Plus & Bonus</th>
